...
import { collapsible, tabs } from '../js/initialization.js';
class SaveCompetitions extends HTMLElement {
    ...
    async render() {
        ...
        if (Object.keys(resultCompetitions).length === 0) document.querySelector('div#competition-error').innerHTML = `<p class="center-align">Data belum tersedia</p>`;
        if (Object.keys(resultTeams).length === 0) document.querySelector('div#team-error').innerHTML = `<p class="center-align">Data belum tersedia</p>`;
    }
}
