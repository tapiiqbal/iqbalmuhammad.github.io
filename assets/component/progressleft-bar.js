class ProgressleftBar extends HTMLElement {
    constructor() {
        super();
    }
    ...
    render() {
        ...
        progress[value]::-webkit-progress-value {
            ...
            <progress class="progress-left" max="100" value="80"></progress>
        `;
        const elems = document.querySelector('.progress-left');
        console.log(elems);

    }
}
customElements.define("progressleft-bar", ProgressleftBar);